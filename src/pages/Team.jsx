          ...
          <div className="card bg-light">
            <div className="card-body text-center">
              <img
                ...
                alt=""
              />
              <h3 className="card-title mb-3">Oscar Wooding</h3>
              <h6 className="card-subtitle">Co - Head of Portfolio Management</h6>
              <hr />
            </div>
          </div>
        </div>*/}
          ...
          <div className="card bg-light">
            <div className="card-body text-center">
              <img
                ...
                alt=""
              />
              <h3 className="card-title mb-3">Brendan Patalong</h3>
              <h6 className="card-subtitle">Co - Head of Portfolio Management</h6>
              <hr />
            </div>
          </div>
