    ...
    "silverSponsors": [
        {
            ...
            "buttons": [
                {text: "Spotify", link: "https://open.spotify.com/show/0uT0iw8BkDIvFH12Z3GJKR"},
                {text: "Apple Podcasts", link: "https://podcasts.apple.com/gb/podcast/the-money-maze-podcast/id1504477769"},
                {text: "Introduction Video", link: "https://www.youtube.com/watch?v=9SStZiLZ-KQ&ab_channel=MoneyMazePodcast"}
            ],
        ...
        <div className="grid w-full min-h-[600px] items-center justify-center py-12 gap-4 md:py-24 lg:gap-10">
            <div className="container grid max-w-5xl items-start gap-4 px-4 md:grid-cols-2 md:px-6 lg:gap-8">
                <div className="space-y-2 md:space-y-3">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">Description of the partners.</p>
                </div>
            </div>
            <div className="container max-w-5xl grid items-start gap-6 px-4 md:px-6 lg:gap-8">
                <div className="space-y-8">
                    <div className="space-y-2">
                        <h3 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl text-gold">Gold</h3>
                    </div>
                ...
                <div className="space-y-8">
                    <div className="space-y-2">
                        <h3 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl text-silver">Silver</h3>
                    </div>
                ...
                <div className="space-y-8">
                    <div className="space-y-2">
                        <h3 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl text-bronze">Other</h3>
                    </div>
                ...
                <div className="space-y-8">
                    <div className="space-y-2">
                        <h3 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl text-bronze">Partners</h3>
                    </div>
